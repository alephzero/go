...
static inline errno_t a0go_subscriber_sync_init_unmanaged(a0_subscriber_sync_t* sub_sync,
  ...
  return a0_subscriber_sync_init_unmanaged(sub_sync, shmobj, alloc, sub_init, sub_iter);
}
...
static inline errno_t a0go_subscriber_init_unmanaged(a0_subscriber_t* sub,
  ...
  return a0_subscriber_init_unmanaged(sub, shmobj, alloc, sub_init, sub_iter, packet_callback);
}
